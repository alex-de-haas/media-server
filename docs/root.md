...
- **file-directory-management** — [feature](features/file-directory-management/feature.md)
...
- **native-client-api** — [feature](features/native-client-api/feature.md) · [plan](features/native-client-api/plan.md): In Progress, updated 2026-08-04
