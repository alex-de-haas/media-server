...
tracking](features/release-tracking/feature.md) (a watchlist and release calendar over
...
- [Catalogs](features/catalogs/feature.md)
...
- [Multi-movie ingest (franchise packs)](features/multi-movie-ingest/feature.md)
- [Metadata](features/metadata/feature.md)
- [Storage and data](features/storage-and-data/feature.md)
- [Collections](features/collections/feature.md)
- [Jellyfin compatibility](features/jellyfin-compatibility/feature.md)
- [File and directory management](features/file-directory-management/feature.md)
...
- [Build and deployment](features/build-and-deployment/feature.md)
- [Release tracking](features/release-tracking/feature.md)
- [Watchlist and discovery](features/watchlist-and-discovery.md)
- [Hosty platform requests](features/hosty-platform-requests/feature.md)
...
- **apple-client** — [feature](features/apple-client/feature.md) · [plan](features/apple-client/plan.md): In Progress, updated 2026-09-07
- **apple-client-core** — [plan](features/apple-client-core/plan.md): In Progress, updated 2026-08-31
- **apple-client-visual-design** — [feature](features/apple-client-visual-design/feature.md) · [plan](features/apple-client-visual-design/plan.md): In Progress, updated 2026-09-15
- **apple-playback-buffering** — [feature](features/apple-playback-buffering/feature.md) · [plan](features/apple-playback-buffering/plan.md): In Progress, updated 2026-09-24
- **apple-series-browsing** — [feature](features/apple-series-browsing/feature.md) · [plan](features/apple-series-browsing/plan.md): In Progress, updated 2026-09-08
- **apple-tv-home** — [feature](features/apple-tv-home/feature.md)
- **artwork-language** — [feature](features/artwork-language/feature.md)
- **background-tasks** — [feature](features/background-tasks/feature.md)
- **bluray-import** — [feature](features/bluray-import/feature.md) · [plan](features/bluray-import/plan.md): In Progress, updated 2026-09-25
- **build-and-deployment** — [feature](features/build-and-deployment/feature.md)
- **cache-storage** — [feature](features/cache-storage/feature.md)
- **catalog-maintenance** — [feature](features/catalog-maintenance/feature.md)
- **catalogs** — [feature](features/catalogs/feature.md)
- **collections** — [feature](features/collections/feature.md)
- **convert-dialog** — [feature](features/convert-dialog/feature.md)
- **dolby-vision-profile** — [feature](features/dolby-vision-profile/feature.md)
- **episode-media** — [feature](features/episode-media/feature.md)
- **external-subtitle-delivery** — [plan](features/external-subtitle-delivery/plan.md): On Hold, updated 2026-07-27
- **external-track-sidecars** — [feature](features/external-track-sidecars/feature.md)
- **file-directory-management** — [feature](features/file-directory-management/feature.md) · [plan](features/file-directory-management/plan.md): Draft, updated 2026-09-08
- **frontend-application** — [feature](features/frontend-application/feature.md)
- **groups** — [feature](features/groups/feature.md)
- **hosty-platform-requests** — [feature](features/hosty-platform-requests/feature.md)
- **hosty-runtime-app** — [feature](features/hosty-runtime-app/feature.md)
- **indexing-progress** — [feature](features/indexing-progress/feature.md)
- **ingest-move-recovery** — [plan](features/ingest-move-recovery/plan.md): On Hold, updated 2026-09-23
- **jellyfin-compatibility** — [feature](features/jellyfin-compatibility/feature.md)
- **library-item-tombstones** — [feature](features/library-item-tombstones/feature.md)
- **mcp-tools** — [feature](features/mcp-tools/feature.md) · [plan](features/mcp-tools/plan.md): In Progress, updated 2026-09-03
- **media-probe-providers** — [feature](features/media-probe-providers/feature.md) · [plan](features/media-probe-providers/plan.md): Draft, updated 2026-09-04
- **metadata** — [feature](features/metadata/feature.md)
- **movie-detail-context** — [feature](features/movie-detail-context/feature.md)
- **multi-movie-ingest** — [feature](features/multi-movie-ingest/feature.md)
- **native-client-api** — [feature](features/native-client-api/feature.md)
- **native-playback** — [feature](features/native-playback/feature.md)
- **recommendation-providers** — [feature](features/recommendation-providers/feature.md)
- **release-tracking** — [feature](features/release-tracking/feature.md)
- **remux-streaming** — [feature](features/remux-streaming/feature.md) · [plan](features/remux-streaming/plan.md): In Progress, updated 2026-08-15
- **security** — [feature](features/security/feature.md)
- **single-catalog-per-title** — [feature](features/single-catalog-per-title/feature.md)
- **storage-and-data** — [feature](features/storage-and-data/feature.md)
- **stream-title-editing** — [feature](features/stream-title-editing/feature.md)
- **title-preview** — [feature](features/title-preview/feature.md)
- **torrents-and-organizer** — [feature](features/torrents-and-organizer/feature.md) · [plan](features/torrents-and-organizer/plan.md): In Progress, updated 2026-09-24
- **track-extraction** — [feature](features/track-extraction/feature.md)
- **video-part-joining** — [feature](features/video-part-joining/feature.md)
- **watch-history-calendar** — [feature](features/watch-history-calendar/feature.md)
- **watch-history-deletion** — [feature](features/watch-history-deletion/feature.md)
- **watch-history-manual-entries** — [feature](features/watch-history-manual-entries/feature.md)
- **watch-history-providers** — [feature](features/watch-history-providers/feature.md)
