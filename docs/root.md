...
- **library-item-tombstones** — [plan](features/library-item-tombstones/plan.md): In Progress, updated 2026-07-26
...
- **single-catalog-per-title** — [plan](features/single-catalog-per-title/plan.md): Draft, updated 2026-07-26
...
- **trakt-favorites-sync** — [plan](features/trakt-favorites-sync/plan.md): Draft, updated 2026-07-26
