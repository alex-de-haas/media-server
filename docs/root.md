...
- **watch-history-calendar** — [plan](features/watch-history-calendar/plan.md): In Progress, updated 2026-07-24
...
- [features/frontend-application](features/frontend-application.md) — Implemented
...
- [ideas/recommendation-providers](ideas/recommendation-providers.md) — Draft
