...
when applicable, followed by the full synopsis and source list. Show all synopsis
text in the scrolling detail screen without line limits, focus styling, or a
separate button or sheet.
