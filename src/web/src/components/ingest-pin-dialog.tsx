...
export function IngestPinDialog({
  ...
  // A movie batch with several videos never reaches this dialog — the activity row routes it to the
  // per-file matching dialog, which is what a franchise pack needs (a single pin would import every video
  // as a version of one movie). So there is nothing to warn about here.
  return (
