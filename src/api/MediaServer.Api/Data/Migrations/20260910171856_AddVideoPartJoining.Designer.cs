...
namespace MediaServer.Api.Data.Migrations
{
    ...
    [Migration("20260910171856_AddVideoPartJoining")]
    partial class AddVideoPartJoining
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediaServer.Api.Data.AppSettings", b =>
                {
                    ...
                    b.Property<string>("MetadataChangesSyncedThrough")
                        .HasColumnType("TEXT");

                    b.Property<string>("MetadataRefreshRetries")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MediaServer.Api.Data.Catalog", b =>
                {
                    ...
                    b.Property<string>("MountLabel")
                        .HasColumnType("TEXT");

                    b.Property<string>("MountRelativePath")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("Root")
                        .IsUnique()
                        .HasFilter("\"MountLabel\" IS NULL");

                    b.HasIndex("MountLabel", "MountRelativePath")
                        .IsUnique();

                    b.ToTable("Catalogs");
                });

            modelBuilder.Entity("MediaServer.Api.Data.ChangeLogEntry", b =>
                {
            ...
            modelBuilder.Entity("MediaServer.Api.Data.ImageAsset", b =>
                {
                    ...
                    b.HasIndex("MediaItemId", "RemotePath")
                        .IsUnique();
            ...
            modelBuilder.Entity("MediaServer.Api.Data.IngestItem", b =>
                {
                    ...
                    b.Property<Guid?>("ConflictCatalogId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MediaServer.Api.Data.MediaItem", b =>
                {
                    ...
                    b.Property<string>("PreferredPosterTag")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MediaServer.Api.Data.MediaStream", b =>
                {
                    ...
                    b.Property<int?>("SourceStreamIndex")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MediaServer.Api.Data.MetadataTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<Guid>("MetadataRecordId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MediaServer.Api.Data.PlaybackHistoryEntry", b =>
                {
                    ...
                    b.Property<bool>("ProviderEntryOwned")
                        .HasColumnType("INTEGER");

                    b.Property<string>("ProviderHistoryId")
                        .HasMaxLength(128)
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("AppUserId", "WatchedAt");

                    b.HasIndex("ProviderKey", "ProviderHistoryId");

                    b.HasIndex("AppUserId", "MediaItemId", "PlaySessionId")
                        .IsUnique()
            ...
            modelBuilder.Entity("MediaServer.Api.Data.PlaybackPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<bool>("PreferOriginalAudio")
                        .HasColumnType("INTEGER");

                    b.Property<string>("SubtitleLanguage")
                        .HasColumnType("TEXT");

                    b.Property<bool>("SubtitlesForcedOnly")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MediaServer.Api.Data.PlaybackSession", b =>
                {
                    ...
                    b.Property<string>("LastReportAt")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<bool>("ObservedBelowThreshold")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MediaServer.Api.Data.RecommendationShelfItem", b =>
                {
                    ...
                    b.HasIndex("AppUserId", "Rank")
                        .IsUnique();

                    b.ToTable("RecommendationShelfItems");
                });
            ...
            modelBuilder.Entity("MediaServer.Api.Data.TranscodeJob", b =>
                {
                    ...
                    b.Property<string>("LastSubmissionAt")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<bool>("OutputImported")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("ReEncodedAudioTracks")
                        .HasColumnType("INTEGER");

                    b.Property<string>("SecondInputPath")
                        .HasColumnType("TEXT");

                    b.Property<Guid?>("SecondSourceId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MediaServer.Api.Data.TranscodeJobOutput", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MediaServer.Api.Data.UserItemData", b =>
                {
                    ...
                    b.Property<string>("LastWatchedAt")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("WatchedStateChangedAt")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MediaServer.Api.Data.WatchHistoryFavoriteState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("RemoteFavoritedAt")
                        .HasColumnType("TEXT");

                    b.Property<bool>("RemotePresent")
                        .HasColumnType("INTEGER");

                    b.HasKey("Id");

                    b.HasIndex("ConnectionId", "Kind", "IdentityProvider", "IdentityProviderId")
                        .IsUnique();

                    b.ToTable("WatchHistoryFavoriteStates");
                });
            ...
            modelBuilder.Entity("MediaServer.Api.Data.WatchHistoryOutboxEvent", b =>
                {
                    ...
                    b.Property<string>("RemoteIdSnapshot")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MediaServer.Api.Data.WatchHistoryProviderConnection", b =>
                {
                    ...
                    b.Property<string>("CredentialExpiresAt")
                        .HasColumnType("TEXT");

                    b.Property<int?>("FavoritesCapacity")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("FavoritesRemoteCount")
                        .HasColumnType("INTEGER");

                    b.Property<string>("LastDeliveryAt")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MediaServer.Api.Data.WatchHistorySyncRun", b =>
                {
                    ...
                    b.Property<string>("CapturedRevisions")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<bool>("HasPendingOutboundWork")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MediaServer.Api.Data.MetadataTag", b =>
                {
                    b.HasOne("MediaServer.Api.Data.MetadataRecord", "MetadataRecord")
                        .WithMany()
                        .HasForeignKey("MetadataRecordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MetadataRecord");
                });
            ...
            modelBuilder.Entity("MediaServer.Api.Data.PlaybackPreference", b =>
                {
                    b.HasOne("MediaServer.Api.Data.AppUser", null)
                        .WithMany()
                        .HasForeignKey("AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MediaServer.Api.Data.TranscodeJobOutput", b =>
                {
                    b.HasOne("MediaServer.Api.Data.TranscodeJob", "TranscodeJob")
                        .WithMany("Outputs")
                        .HasForeignKey("TranscodeJobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MediaServer.Api.Data.WatchHistoryFavoriteState", b =>
                {
                    b.HasOne("MediaServer.Api.Data.WatchHistoryProviderConnection", "Connection")
                        .WithMany()
