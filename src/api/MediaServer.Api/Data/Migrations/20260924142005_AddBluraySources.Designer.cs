...
namespace MediaServer.Api.Data.Migrations
{
    ...
    [Migration("20260924142005_AddBluraySources")]
    partial class AddBluraySources
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediaServer.Api.Data.Download", b =>
                {
                    ...
                    b.Property<string>("CleanupAfter")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<bool>("EngineReleased")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<long>("PlacementBytes")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("PlacementStarted")
                        .HasColumnType("INTEGER");

                    b.Property<long>("PlacementTotalBytes")
                        .HasColumnType("INTEGER");

                    b.Property<long>("RetainedBytes")
                        .HasColumnType("INTEGER");

                    b.Property<string>("RetentionError")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MediaServer.Api.Data.MediaGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MediaServer.Api.Data.MediaGroupMember", b =>
                {
                    ...
                    b.HasKey("MediaGroupId", "MediaItemId");

                    b.HasIndex("MediaItemId");

                    b.ToTable("MediaGroupMember");
                });
            ...
            modelBuilder.Entity("MediaServer.Api.Data.SourceFile", b =>
                {
                    ...
                    b.Property<string>("DiscFileIndexesJson")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("PlacementHash")
                        .HasColumnType("TEXT");

                    b.Property<string>("PlacementPath")
                        .HasColumnType("TEXT");

                    b.Property<string>("PendingLibraryPath")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MediaServer.Api.Data.TranscodeJob", b =>
                {
                    ...
                    b.Property<string>("BluraySelectionJson")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MediaServer.Api.Data.MediaGroupMember", b =>
                {
                    b.HasOne("MediaServer.Api.Data.MediaGroup", null)
                        .WithMany()
